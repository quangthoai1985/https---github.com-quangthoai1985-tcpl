...
// Component for Criterion 1 Evidence Uploader
const Criterion1EvidenceUploader = ({
  ...
  accept?: string;
    ...
    const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const toastId = toast({
            title: 'Đang tải lên...',
            description: `Đang tải tệp "${file.name}". Vui lòng chờ.`,
            duration: Infinity,
        }).id;
        ...
        try {
            ...
            toast.update(toastId, {
                title: 'Lỗi tải lên',
                description: 'Đã xảy ra lỗi khi tải tệp. Vui lòng thử lại.',
                variant: 'destructive',
                duration: 5000,
            });
        } finally {
