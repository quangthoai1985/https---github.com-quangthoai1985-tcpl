                    ...
                    {(formData.documents || []).length > 0 && (
                        <div className="space-y-4 pt-4 border-t">
                            ...
                            {formData.documents?.map((doc, index) => (
                                <div key={index} className="grid grid-cols-1 md:grid-cols-10 gap-x-4 gap-y-3 items-start p-3 border rounded-md bg-white">
                                    <div className="md:col-span-1 flex items-center justify-center pt-2">
                                        <div className="h-8 w-8 flex items-center justify-center rounded-full bg-blue-200 text-blue-800 font-bold text-sm border border-blue-400">
                                            {index + 1}
                                        </div>
                                    </div>
                                    <div className="md:col-span-9 grid gap-1.5">
                                        <Label htmlFor={`doc-name-${index}`} className="text-xs font-semibold">Tên văn bản QPPL</Label>
                                    ...
                                    <div className="md:col-span-9 grid gap-1.5">
                                        <Label htmlFor={`doc-excerpt-${index}`} className="text-xs font-semibold">Trích yếu nội dung</Label>
                                    ...
                                    <div className="md:col-span-5 grid gap-1.5">
                                        <Label htmlFor={`doc-issuedate-${index}`} className="text-xs font-semibold">Ngày ban hành</Label>
                                    ...
                                    <div className="md:col-span-4 grid gap-1.5">
                                        <Label htmlFor={`doc-deadline-${index}`} className="text-xs font-semibold">Thời hạn ban hành (ngày)</Label>
...
export default Criterion1Config;
